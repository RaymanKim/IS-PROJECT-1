...
<body class="font-sans antialiased m-0">
    <div class="bg-gray-50 text-black/50 flex flex-col min-h-screen">
                    ...
                    <div class="hidden lg:flex lg:items-center space-x-4 list-none">
                        ...
                        @auth('doctor')
                            <li>
                                ...
                                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] no-underline">Doctor Logout</a>
                            </li>
                        @else
                            <li>
